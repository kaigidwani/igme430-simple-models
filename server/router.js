...
const router = (app) => {
  ...
  // For example, a form submission to www.webpage.com/setDogName
  app.post('/setDogName', controllers.setDogName);

  // When someone POSTS to /updateLast, call controllers.updateLast
  app.post('/updateLast', controllers.updateLast);

  // When someone POSTS to /ageDogByName, call controllers.ageDogByName
  app.post('/ageDogByName', controllers.ageDogByName);
};
